            ...
            <React.Fragment>
                <Helmet>
                    ...
                    {(style === 'bold') ? (
                      ...
                      <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,300;0,500;0,700;1,100;1,300;1,400;1,700&display=swap" rel="stylesheet"></link>
                    ) : 
                      (font === 'serif') ? (
